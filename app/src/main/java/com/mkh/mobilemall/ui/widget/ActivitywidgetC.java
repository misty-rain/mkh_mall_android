 ...
 */
public class ActivitywidgetC extends LinearLayout {
    private ImageView one;
    private SharePreferenceUtil sUtil;
    public ActivitywidgetC(Context context, AttributeSet attrs) {
        super(context, attrs);
        View.inflate(context, R.layout.activity_item_type_three, this);
        one= (ImageView) findViewById(R.id.three_image);
