 ...
 */
public class ActivitywidgetA extends LinearLayout {
    private ImageView one;
    private SharePreferenceUtil sUtil;
    public ActivitywidgetA(Context context, AttributeSet attrs) {
        super(context, attrs);
        View.inflate(context, R.layout.activity_item_type_one, this);
        one= (ImageView) findViewById(R.id.one_image);
