 ...
 */
public class ActivitywidgetD extends LinearLayout {
    private ImageView one,two;
    private SharePreferenceUtil sUtil;
    public ActivitywidgetD(Context context, AttributeSet attrs) {
        super(context, attrs);
        View.inflate(context, R.layout.activity_item_type_two, this);
        sUtil = GlobalContext.getInstance().getSpUtil();
        one= (ImageView) findViewById(R.id.four_image_one);
        two= (ImageView) findViewById(R.id.four_image_two);
