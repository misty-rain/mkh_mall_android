...
package com.mkh.mobilemall.ui.widget.appmsg;
...
public class AppMsg {
    ...
    /**
     * Make a  with a custom layout. The layout must have a {@link TextView} com id {@link android.R.id.message}
     *
     * @param context The context to use. Usually your
     *                {@link Activity} object.
     * @param text    The text to show. Can be formatted text.
    ...
    /**
     * Make a non-floating  with a custom view presented inside the layout.
    ...
    /**
     * Make a  with a custom view. It can be used to create non-floating notifications if floating is false.
     *
     * @param context  The context to use. Usually your
     *                 {@link Activity} object.
    ...
    /**
     * Make a  that just contains a text view with the text from a
     * resource.
     *
     * @param context The context to use. Usually your
     *                {@link Activity} object.
    ...
    /**
     * Make a  with a custom layout using the text from a
    ...
    /**
     * @return <code>true</code> if the is being displayed, else <code>false</code>.
     */
    ...
    /**
     * Cancels all queued s, in all Activities. If there is a {@link com.xiniu.pos.support.widgets.appmsg.AppMsg}
    ...
    /**
     * Cancels all queued s, in given {@link Activity}.
     * If there is a displayed currently, it will be the last one displayed.
     *
     * @param activity
     */
    ...
    /**
     * The style for a {@link com.xiniu.pos.support.widgets.appmsg.AppMsg}.
     *
     * @author e.shishkin
     */
    public static class Style {
        ...
        /**
         * Construct an {@link com.xiniu.pos.support.widgets.appmsg.AppMsg.Style} object.
         *
