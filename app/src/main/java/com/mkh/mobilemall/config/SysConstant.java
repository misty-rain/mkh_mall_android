...
public class SysConstant {
    ...
    public static final int BACKRESULTCODE_CART_DISTRIBUTION_DATE=1000; //配送时间
    public static final int BACKRESULTCODE_CART_DISTRIBUTION_TYPE=1001; //配送方式
     public static final int BACKRESULTCODE_CART_PAY_TYPE=1002; //支付方式
    public static final int BACKRESULTCODE_CART_DISCOUNT_TICKET=1003; //优惠券
    public static final int BACKRESULTCODE_CART_REICEVEADDRESS=1004;//收货地址

    public static final String PAYNAME_SMILECARD ="微笑卡";
    public static final String PAYNAME_ALIPAY ="支付宝";
    public static final String PAYNAME_WECHAT ="微信";
